...
def map_category_to_department(category: str) -> str:
    ...
    category_mapping = {
        ...
        '河川砂防海岸': '河川、砂防及び海岸・海洋',
        '河川砂防': '河川、砂防及び海岸・海洋',  # 2008年度
        '河川砂防海岸海洋': '河川、砂防及び海岸・海洋',  # 2010年度
        '河川砂防及び海岸・海洋': '河川、砂防及び海岸・海洋',  # 2012年度
        '河川、砂防及び海岸･海洋': '河川、砂防及び海岸・海洋',  # 2013年度
        '河川・砂防及び海岸・海洋': '河川、砂防及び海岸・海洋',  # 2014年度
    ...
    return '道路'  # CLAUDE.md準拠：日本語デフォルト
